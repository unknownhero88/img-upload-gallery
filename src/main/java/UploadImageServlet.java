...
public class UploadImageServlet extends HttpServlet {
    ...
    private static final String IMGBB_API_KEYLocal = "34d8f020849d0373dd10544fb315c979";
    private static final String DB_URLLocal = "jdbc:mysql://bgveyko0x5lxpoqktzss-mysql.services.clever-cloud.com:3306/bgveyko0x5lxpoqktzss";
    private static final String DB_USERLocal = "uuaabzyzcnqdvsx5";
    private static final String DB_PASSLocal = "VWxNmmp0txlTcxyTjsYe";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (imageUrl != null) {
                // Store URL in MySQL
                boolean stored = storeImageUrlInDatabase(imageUrl);
    ...
    private boolean storeImageUrlInDatabase(String imageUrl) {
        Connection con = null;
        ...
        try {
            ...
            String sql = "INSERT INTO images (image_url, uploaded_at) VALUES (?, NOW())";
    ...
    private void sendSuccessResponse(PrintWriter out, String imageUrl, boolean stored, long originalSize) {
        ...
        out.println("<div>");
        out.println("<a href='upload.jsp' class='btn'>Upload Another</a>");
        out.println("<a href='show.jsp' class='btn'>View Gallery</a>");
        out.println("</div>");
        out.println("</div>");
        out.println("</body>");
        out.println("</html>");
