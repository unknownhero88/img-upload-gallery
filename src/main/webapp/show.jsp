...
<div class="container">
    ...
    try {
        ...
        // Count total images
        ResultSet countRs = st.executeQuery("SELECT COUNT(*) as total FROM images");
        if (countRs.next()) {
    ...
    <div class="gallery">
    <%
        rs = st.executeQuery("SELECT * FROM images ORDER BY id DESC");
    ...
    %>
        <div class="error">
            <strong>Error:</strong> MySQL Driver not found. Please add mysql-connector-java to your project.
        </div>
    <%
