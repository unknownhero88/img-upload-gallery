...
<div class="container">
    <div class="hero">
        ...
        <div class="card-container">
            <a href="upload.jsp" class="card upload">
                <span class="card-icon">⬆️</span>
                <h3 class="card-title">Upload Image</h3>
                <p class="card-description">Upload your photos to the cloud with drag & drop support</p>
            </a>
            
            <a href="show.jsp" class="card">
                <span class="card-icon">🖼️</span>
                <h3 class="card-title">View Gallery</h3>
                <p class="card-description">Browse and manage all your uploaded images in one place</p>
            </a>
        </div>
    ...
    <footer>
        <p>Built with ❤️ using Java Servlets & MySQL</p>
    </footer>
</div>
